...
function InvoiceDetail() {
  ...
  return (
    <>
      <div className="bg-gray-light flex flex-col md:flex-row min-w-screen md:max-h-screen">
        <div className="">
          <Sidebar />
          <button
            onClick={() => {
        ...
        <Main>
          ...
          <section className="md:flex justify-between items-center p-5 bg-white my-5 rounded-lg">
            <div className="flex justify-between gap-4 items-center">
              <p className="text-gray-dark">Status</p>
              <div
          ...
          <section className="bg-white rounded-lg px-6 py-6 md:py-8 md:px-12">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3">
              ...
              <div>
                <ul className="text-gray-dark md:text-right flex flex-col mb-3">
            ...
            <div className="p-6 my-4 md:my-8 md:p-10 bg-blue-50">
              <ul className="flex gap-5 flex-col">
                ...
                {invoice.items.map((item, i) => (
                  <li
                    key={i}
                    className="flex md:gap-20 text-tertiary-dark font-bold justify-between items-center md:items-start"
                  >
                    ...
                    <div className="md:hidden">
                      ...
                      <div className="flex gap-3">
                        ...
                        <span className="text-primary-dark">X</span>
                        <p className="text-primary-dark md:flex-1">
                          {formatCurrency(item.price)}
                        </p>
                      </div>
              ...
              <div className="mt-5 flex items-center bg-tertiary-dark md:p-10 p-5 md:pr-20 rounded-lg font-sans text-white justify-between">
                <p>Amount Due</p>
